...
function GoogleButton() {
  ...
  return (
    ...
    <button
      ...
      disabled={busy}
      className="w-full flex items-center justify-center gap-3 h-14 rounded-2xl text-base font-semibold transition-all hover:bg-gray-50 active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed"
    ...
    >
      ...
      {loading ? "Redirecting to Google…" : !isLoaded ? "Loading…" : "Continue with Google"}
    </button>
    {error && (
